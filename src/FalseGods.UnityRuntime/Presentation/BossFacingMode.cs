namespace FalseGods.UnityRuntime.Presentation
{
    ...
    /// same facing. <see cref="Fixed"/> is scripted/static. Measured in-game at B0 (2026-07-14); carried over from the
    /// throwaway probe renderer unchanged. A boss picks the mode that fits it (a huge boss wants Fixed or
    /// NearestPlayer, a small mook wants LocalBillboard).
    /// </remarks>
    public enum BossFacingMode
    {
        /// <summary>
